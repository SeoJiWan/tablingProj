							...
							<div class="daily_obj _ccast_list_group">
						 		<div class="tx_tooltip">
									...
									<div id="title_group">
										...
										<div class = "title_famaily" style="width:100px;"><i class="fa-solid fa-pen-nib" style="font-size:12px;"></i> ${boardDetail.nickName}</div>
										<div class = "title_famaily" style="width:280px">${boardDetail.title}</div>
										<div class = "title_famaily"><i class="fa-solid fa-calendar-days" style="font-size:12px;"></i> ${boardDetail.createDate}</div>
										<div class = "title_famaily"><i class="fa-regular fa-eye" style="font-size:12px;"></i> ${boardDetail.hits}</div>
									</div>
									<div id="btn_btn_btn">
										...
										<c:when test="${!empty loginMember.memberId && loginMember.memberId eq boardDetail.memberId }">
											<ul id = "writer_btn">
												<li>
													...
													<button class="cmt_login_btn" id ="postUpdate_save_btn" value="저장" style="display:none; cursor:pointer;"><i class="uil uil-check-circle" style="color:#2AAB56;"></i></button>
													<!-- 취소버튼 -->
												</li>
											</ul>
										</c:when>
					 		...
					 		<a id ="go_list_btn" href= "postListPaging.do?pageNum=1&postNum=4"><i class="fa-solid fa-line-columns" style="text-align:center;"></i>목록으로</a>
					 		<!-------------------------------------------------------------------- 댓글 입력 -------------------------------------------------------------------->
